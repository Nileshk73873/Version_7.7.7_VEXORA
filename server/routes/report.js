...
<head>
  <meta charset="UTF-8">
  <title>WebSec AI Assessment Report - ${escapeHtml(scan.target_url)}</title>
  <style>
...
<body>
  ...
  <div class="header">
    <h1>🛡️ WebSec AI Assessment Report</h1>
  ...
  <div class="footer">
    <p>Generated by WebSec AI Tool v1.0. This report is for authorized security testing only.</p>
  </div>
</body>
</html>
    `;

    const filename = `websec-report-${scanId.slice(0, 8)}-${Date.now()}.html`;
